...
os.chdir('C:\\Users\\gheii\\Desktop\\SP-500-Stock-Prediction-master')
...
for year in tqdm(available_years):
    ...
    # taking idea from using xgboost for the regression
   
    xgb_r = xgb.XGBRegressor()
    xgb_r.fit(_train_X,_train_y)
    _pred_y = xgb_r.predict(_test_X)
